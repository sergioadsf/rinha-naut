...
set CLASSPATH=%APP_HOME%\lib\rinha-naut-0.1-all.jar

@rem Execute rinha-naut
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RINHA_NAUT_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%RINHA_NAUT_EXIT_CONSOLE%" exit 1
exit /b 1
